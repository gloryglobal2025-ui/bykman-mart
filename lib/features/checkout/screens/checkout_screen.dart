...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> initCall() async {
    ...
    if (isLoggedIn) {
      ...
      Get.find<CheckoutController>().insertAddresses(
      ...
      if (Get.find<SplashController>().proStaus &&
          Get.find<ProfileController>().proStatus) {
      ...
      Get.find<CheckoutController>().setGuestAddress(
        AddressHelper.getUserAddressFromSharedPref(),
        isUpdate: false,
      );
    }
      ...
      body: guestCheckoutPermission || AuthHelper.isLoggedIn()
          ? GetBuilder<CheckoutController>(
              builder: (checkoutController) {
                ...
                print(
                  '====> COD : $_isCashOnDeliveryActive, Digital : $_isDigitalPaymentActive, Offline : $_isOfflinePaymentActive',
                );
                  ...
                  builder: (couponController) {
                    ...
                    if ((checkoutController.isFirstTime ||
                      ...
                      Future.delayed(const Duration(milliseconds: 50), () {
                        ...
                        print(
                          '[DEBUG] PlaceOrderBody (parcel) monthlySubscribe: ${placeOrderBody.monthlySubscribe}',
                        );

                        if ((widget.storeId == null &&
                                _cartList != null &&
                                _cartList!.isNotEmpty &&
                                placeOrderBody.storeId != null) ||
                            (widget.storeId != null)) {
                    ...
                    final double saverDeliveryAdjustment =
                        (checkoutController.orderType == 'delivery' &&
                    ...
                    if (!_isCashBackSnackBarShown &&
                        checkoutController.distance != null &&
                        checkoutController.distance != -1.0 &&
                        isLoggedIn &&
          ...
          onPressed: checkoutController.acceptTerms
              ? () async {
                  ...
                  if (AuthHelper.isLoggedIn()) {
                    String numberWithCountryCode =
                        checkoutController.countryDialCode! +
                        checkoutController.contactPersonNumberController.text;
                    PhoneValid phoneValid = await CustomValidator.isPhoneValid(
                      numberWithCountryCode,
                    );
                  ...
                  if (isGuestLogIn &&
                    ...
                    showCustomSnackBar('please_enter_contact_person_email'.tr);
                      ...
                      checkoutController
                          .contactPersonAddressController
                          .text
                          .isEmpty &&
                      checkoutController.orderType != 'take_away') {
                    ...
                    showCustomSnackBar('please_enter_valid_phone_number'.tr);
                      ...
                      checkoutController
                          ...
                          .isEmpty) {
                    showCustomSnackBar(
                      'please_enter_contact_person_address'.tr,
                    );
                    ...
                    print(
                      '=====> checkout controller Address: ${checkoutController.address?.toJson()}',
                    );
                    ...
                    if (AuthHelper.isLoggedIn()) {
                      finalAddress?.contactPersonName =
                          checkoutController.contactPersonNameController.text;
                      finalAddress?.contactPersonNumber =
                          checkoutController.countryDialCode! +
                          checkoutController.contactPersonNumberController.text;
                    ...
                    if (widget.storeId == null) {
                      ...
                      print(
                        '[DEBUG] PlaceOrderBody (regular) monthlySubscribe: ${placeOrderBody.monthlySubscribe}',
                      );
                      ...
                      checkoutController.placePrescriptionOrder(
                        ...
                        longitude: finalAddress.longitude!,
                        latitude: finalAddress.latitude!,
                        note: checkoutController.noteController.text,
                        orderAttachment: checkoutController.pickedPrescriptions,
                        savedImages: checkoutController
                            .pickedPrescriptionSavedImageNames
                            .whereType<String>()
                            .toList(),
                        dmTips:
                            (checkoutController.orderType == 'take_away' ||
  ...
  double _calculateOriginalDeliveryCharge({
    ...
    if (store != null &&
      ...
      print(
        'Fixed shipping charge perKmCharge, minimumCharge, maximumCharge :: $perKmCharge, $minimumCharge, $maximumCharge',
      );
    }
  ...
  double _calculateProDiscount(
    ...
    final bool meetsMinOrder =
        benefit.minOrderStatus != true ||
        subTotal >= (benefit.minOrderAmount ?? 0);
